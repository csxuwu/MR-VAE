...
def generate_dataset(gamma_ranges, in_path, out_path, img_w, img_h, is_resize=False):
    for img_name in os.listdir(in_path):
        ...
        # 存储新图片
        new_out_path = os.path.join(out_path, img_name)
...
def generate_dataset_batch():
    in_path = r'E:\Detect_dataset\VOC2007\VOCtest_06-Nov-2007\VOCdevkit\VOC2007\JPEGImages'
    # in_path = r'E:\Detect_dataset\test'
    # out_path = r'E:\Detect_dataset\test_out'
    out_path = r'E:\Detect_dataset\VOC2007_ll\VOCtest_06-Nov-2007\VOCdevkit\VOC2007\JPEGImages'
    ...
    generate_dataset(gamma_ranges=[1.5,4.5], in_path=in_path, out_path=out_path,
