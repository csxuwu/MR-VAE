...
import os
import time
from choice import cfg_v2_4
from choice import mrvae_v2_4_1
from choice import mrvae_v2_4_2
from choice import mrvae_v2_4_3
...
def train():
    ...
    t_image_ph, t_org_image_ph, decoder_GR, decoder_DR, psnr_GR, psnr_DR, ssim_GR, ssim_DR, global_steps, train_step, lr, vae_loss = mrvae()
