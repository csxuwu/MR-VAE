...
# name = 'mrvae_v2_2_3'
name = 'mrvae_v2_2_2'
path = 'summary/mrvae_v2_2'
# ========================= mrvae_v2_2_1 gamatest512-train ==========================
# train_summary_path = os.path.join(path,'train_gamatest512-train/summary')
# train_out_path = os.path.join(path,'train_gamatest512-train/out')
# eval_summary_path = os.path.join(path, 'test_gamatest512-train/summary')
# eval_out_path = os.path.join(path, 'test_gamatest512-train/out')
# ======================================= end =======================================

# train_summary_path = 'D:\WuXu\Code\Python_code/vae_multi09/vae_multi0903\log/vae_multi0903-07/train_epoch6_2/summary'

# ========================= mrvae_v2_2_3 Synthetic_train_set4_downsample_by_k3s2 =========================
# train_out_path = os.path.join(path, name, 'train_Synthetic_train_set4_downsample_by_k3s2/out')
# train_summary_path = os.path.join(path, name, 'train_Synthetic_train_set4_downsample_by_k3s2/summary')
# eval_summary_path = os.path.join(path, name, 'test_Synthetic_train_set4_downsample_by_k3s2/summary')
# eval_out_path = os.path.join(path, name, 'test_Synthetic_train_set4_downsample_by_k3s2/out')
# =========================================== end ===========================================

# ========================= mrvae_v2_2_1 LOLdataset_our485_2 =========================
...
# ========================= mrvae_v2_2_2 Synthetic_train_set4 =========================
