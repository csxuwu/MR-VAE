...
def PA(GR_upsampling1, GR_upsampling2, GR_upsampling3, GR_upsampling4):
    '''
    第二阶段，参考SRResnet
    :param inputs:
...
def pavae():
    ...
    with tf.name_scope(cfg.name):
        ...
        decoder_second_out = PA(GR_upsampling1, GR_upsampling2, GR_upsampling3, GR_upsampling4)
